...
public class GetRecordsTest extends OperationTestBase {
    ...
    /**
     * Test SortBy ASC of document with prefix (apiso:) in the PropertyName
     * GetRecords with SOAP method using Soap encoding
     *
     * @throws Exception
     */
    @Test
    public void testSoapGetRecordsSortWithPrefix() throws Exception {
        ...
        HttpServletRequest request = context.mock( HttpServletRequest.class );
        HttpServletResponse response = context.mock( HttpServletResponse.class );
        String requestStr = TestRequests.getRequest( TestRequests.GETRECORDS_2_FULL_SOAP );
    ...
    /**
     * Test SortBy DESC of document with prefix (apiso:) in the PropertyName
     * GetRecords with SOAP method using Soap encoding
     *
     * @throws Exception
     */
    ...
    public void testSoapGetRecordsSortWithPrefixDesc() throws Exception {
        ...
        HttpServletRequest request = context.mock( HttpServletRequest.class );
        HttpServletResponse response = context.mock( HttpServletResponse.class );
        String requestStr = TestRequests.getRequest( TestRequests.GETRECORDS_2_FULL_SOAP_DESC );
