...
public class StringUtilsTest {
    ...
    @Test
    void testSplitByFirstOccurence() {
    ...
    @Test
    void testDOM2StringConversion() throws SAXException, IOException {
    ...
    @Test
    void testMultiTHreadedDOM2StringConversion() throws SAXException,
            IOException {
