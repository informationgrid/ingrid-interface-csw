        ...
        if (hits.length() > 0) {
            ...
            if (metadataNode != null) {
                ...
                if (metadataIdNode != null) {
                    metadataIdNode.setText(("ingrid:" + hit.getPlugId() + ":" + hit.getDocumentId() + ":original-response").replaceAll(INVALID_XML_ID_CHARS_REGEX_STR, "_"));
                } else {
                    metadataNode.addAttribute("id", ("ingrid:" + hit.getPlugId() + ":" + hit.getDocumentId() + ":pass-through").replaceAll(INVALID_XML_ID_CHARS_REGEX_STR, "_"));
                }
