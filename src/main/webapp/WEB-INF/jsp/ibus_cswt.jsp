...
<body>
	...
	<c:set var="active" value="cswtIbus" scope="request"/>
	...
	<div id="contentBox" class="contentMiddle">
        ...
        <form:form method="post" action="ibus_cswt.html" modelAttribute="harvester">
        ...
        <tr>
	    	...
	    	<br>
	    	<span>The Client ID used for registration on the iBus (i.e. /ingrid-group:interface-csw-t).</span>
    	...
    	<td class="leftCol">&nbsp;</td>
        <td>
			<button type="submit" name="next" value="next">Save Communication</button>
        </td>
        </tr>
        </table>
