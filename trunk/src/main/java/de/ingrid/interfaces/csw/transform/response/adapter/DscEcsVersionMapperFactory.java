...
public class DscEcsVersionMapperFactory {
	...
	public static DscEcsVersionMapper getEcsDscVersionMapper(IngridHit hit) {
		...
		if (IPlugVersionInspector.getIPlugVersion(hit).equals(IPlugVersionInspector.VERSION_IDC_1_0_8_DSC_OBJECT)) {
			return DscEcsVersionMapper_Udk_5_0_TO_IDC_1_0_8.instance();
		} else if (IPlugVersionInspector.getIPlugVersion(hit).equals(IPlugVersionInspector.VERSION_IDC_1_0_5_DSC_OBJECT)) {
